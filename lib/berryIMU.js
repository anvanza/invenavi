...
class BerryIMU {
    ...
    fullInformation() {
        ...
        this.insertMagValuesForCalibration(MAG);
        ...
        return {
            ...
            magCalibration: {
              XAngle: (this.magXmin + this.magXmax) / 2,
              YAngle: (this.magYmin + this.magYmax) / 2,
              ZAngle: (this.magZmin + this.magZmax) / 2,
            },
            heading: heading,
            tiltCompensatedHeading: tiltCompensatedHeading,
            tiltCompensatedCompass: angles.compass(tiltCompensatedHeading),
            pitch: pitch,
            roll: roll,
            temperature: TMP,
            looptime: looptime,
    ...
    calibrateCompass(timeOut = 10000) {
        ...
        //calibration failed
        if (this.magXmin === 32767 || this.magXmax === -32767) {
    ...
    insertMagValuesForCalibration(MAG) {
        if (this.magXmin === 0) {
            //not calibrated
            this.magXmin = 32767;
            this.magYmin = 32767;
        ...
        if (MAG.x > this.magXmax) {
            this.magXmax = MAG.x
        }
        if (MAG.y > this.magYmax) {
            this.magYmax = MAG.y
        }
        if (MAG.z > this.magZmax) {
            this.magZmax = MAG.z
        }

        if (MAG.x < this.magXmin) {
            this.magXmin = MAG.x
        }
        if (MAG.y < this.magYmin) {
            this.magYmin = MAG.y
        }
        if (MAG.z < this.magZmin) {
            this.magZmin = MAG.z
        }
    }
